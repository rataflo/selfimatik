...
MENU(menuPositions, "Positions", doNothing ,noEvent, noStyle
  ...
  ,FIELD(parametres.servoRotatePos,"Arm Rotation","",-5700,0,1,0,saveParams ,exitEvent, noStyle)
  ,FIELD(parametres.tankPos[0],"Tank 1","",-5700,0,1,0,saveParams ,exitEvent, noStyle)
  ,FIELD(parametres.tankPos[1],"Tank 2","",-5700,0,1,0,saveParams ,exitEvent, noStyle)
  ,FIELD(parametres.tankPos[2],"Tank 3","",-5700,0,1,0,saveParams ,exitEvent, noStyle)
  ,FIELD(parametres.tankPos[3],"Tank 4","",-5700,0,1,0,saveParams ,exitEvent, noStyle)
  ,FIELD(parametres.tankPos[4],"Tank 5","",-5700,0,1,0,saveParams ,exitEvent, noStyle)
  ,FIELD(parametres.tankPos[5],"Tank 6","",-5700,0,1,0,saveParams ,exitEvent, noStyle)
  ,FIELD(parametres.tankPos[6],"Tank 7","",-5700,0,1,0,saveParams ,exitEvent, noStyle)
  ,FIELD(parametres.tankPos[7],"Tank 8","",-5700,0,1,0,saveParams ,exitEvent, noStyle)
  ,EXIT("<Back")
);
